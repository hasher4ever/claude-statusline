...
```
myproject | main ✱ 12f 74e +318 -90 | Opus 4.8 1M high | 5h 5% ↻4h30m · 7d 16% ↻3d18h | ctx 157k (16%) + sub 1× 17k = 174k | session $8.65 | today $12 · yest $9 · week $48 · lwk $63 · mon $210 · all $980 | 2026-01-01 14:19:05
```
...
| `main ✱ 12f 74e +318 -90` | Git branch · `✱` uncommitted · `↑/↓` ahead/behind upstream · **this session**: files edited (`12f`) + edit ops (`74e`) + lines added/removed (`+318 -90`) |
